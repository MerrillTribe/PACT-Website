...
import FrequencyViewToggle from '@site/src/components/FrequencyViewToggle';
...
:::tip Frequency Display
**Operator View** shows the repeater output frequency and tone normally needed to use the repeater.
 
**Technical View** also shows the repeater input frequency. **Output (RX)** is the repeater output and the frequency your radio receives. **Input (TX)** is the repeater input and the frequency your radio transmits on.
:::

## Local Nets

<div className="net-frequency-table">

| Net | Day | Time | <span className="operator-only">Frequency (MHz)</span><span className="technical-only">Output (RX)</span> | <span className="technical-only">Input (TX)</span> | CTCSS |
|---|---|---|---:|---:|---:|
...
<div className="repeater-table-wrap repeater-frequency-table">
 
| <span className="operator-only">Frequency</span><span className="technical-only">Output (RX)</span> | <span className="technical-only">Input (TX)</span> | Location | Area | Site Name | Call | Sponsor | CTCSS | Links |
|---:|---:|---|---|---|---|---|---:|---|
...
| <span className="operator-only">Frequency</span><span className="technical-only">Output (RX)</span> | <span className="technical-only">Input (TX)</span> | Site Name | Callsign | CTCSS | Notes |
|---:|---:|---|---|---:|---|
...
| <span className="operator-only">Frequency</span><span className="technical-only">Output (RX)</span> | <span className="technical-only">Input (TX)</span> | Location | Site Name | Sponsor | Links |
|---:|---:|---|---|---|---|
...
| <span className="operator-only">Frequency</span><span className="technical-only">Output (RX)</span> | <span className="technical-only">Input (TX)</span> | Location | Site Name | Sponsor | CTCSS |
|---:|---:|---|---|---|---:|
