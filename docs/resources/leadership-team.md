...
<div style={{ textAlign: 'center', marginBottom: '2rem' }}>
  <img
    src={useBaseUrl('/img/leadership.png')}
    alt="Leadership Team Organizational Chart"
    width="90%"
  />
</div>
...
<div className="flip-card-grid">
  ...
  <div className="flip-card">
    <div className="flip-card-inner">
      <div className="flip-card-front">
        <h3>Provo City Emergency Manager</h3>
        <h2>Chris Blinzinger</h2>
      </div>
  ...
  <div className="flip-card">
    <div className="flip-card-inner">
      <div className="flip-card-front">
        <h3>Assistant Membership Coordinator</h3>
        <h2>Dave Knecht</h2>
      </div>
      <div className="flip-card-back">
        <ul>
  ...
  <div className="flip-card">
    <div className="flip-card-inner">
      <div className="flip-card-front">
        <h3>Interface Coordinator</h3>
        <h2>Andrew Mulkern</h2>
      </div>
      <div className="flip-card-back">
        <ul>
