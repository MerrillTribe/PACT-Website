...
const config = {
  ...
  tagline:
    'The Provo Auxiliary Communications Team (PACT) is a volunteer team organized to assist Provo City with communications during large emergencies & planned community events.',
